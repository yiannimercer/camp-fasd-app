...
# These are the REAL WordPress field names from the actual export
FASD_SCREENER_FIELDS = {
    'needs_constant_supervision',
    'highly_manipulative',
    'exhausted_from_disrupted_sleep',
    'irritable_from_disrupted_sleep',
    'doesnt_connect_cause_and_effect_behavior_and_consequences',
    'more_difficult_to_manage_in_public_than_at_home',
    'cant_easily_distinguish_between_friend_or_foe',
    'impulsive',
    'unpredictable',
    'engages_in_dangerous_behavior',
    'appears_desperate_for_stimulation_and_excitement',
    'moral_chameleon_excessively_vulnerable_to_peer_pressure',
    'shows_antisocial_behavior',
    'needs_more_structure_and_supervision_than_peers',
    'has_group_learning_and_or_using_concept_of_time',
    'difficulty_managing_money',
    'overreacts_negatively_to_transitions',
    'extremely_vulnerable_to_sales_pitches_ads',
    'doesnt_take_care_of_hygiene_needs',
    'unable_to_take_responsibility_for_actions',
    'cannot_consistently_follow_plan_of_action',
    'doesnt_follow_rules_of_society',
    'vulnerable_to_depression',
    'vulnerable_to_stress_and_overload',
    'lies_and_or_replaces_fact_with_fantasy_unconsciously_in_memory',
    'steals_from_family_members',
    'appears_more_capable_than_he_she_really_is',
    'emotionally_volatile_has_outbursts',
    'destructive_with_possessions_object',
    'violent_toward_animals_or_people',
    'void_of_normal_level_of_empathy_for_other',
    'unexplained_mood_swings',
    'behavior_doesnt_improve_in_spite_of_consistent_consequences',
    'looks_innocent_when_confirmed_guilt',
    'continues_to_deny_guilt_when_confronted_with_indisputable_evidence',
    'egocentricacts_on_own_needs_first',
    'unable_to_stay_focused_on_task',
    'detached_attitude_toward_own_behavior_and_its_consequence',
    'takes_the_path_of_least_resistance',
    'lives_in_the_momentshortsighted',
    'chooses_immediate_gratification_cant_wait_for_greater_benefit',
    'doesnt_display_remorse_not_sorry_for_doing_something_wrong',
    'not_recognized_by_others_as_disabled',
    'appears_undisciplined_regardless_of_consistent_discipline_consequences',
    'charismatic',
    'holds_a_grudge',
    'doesnt_get_the_whole_picture',
    'misunderstands_what_is_expected',
    'predatoryplans_to_harm_others',
    'becomes_angry_when_confronted_with_wrongdoing',
    'thinks_he_she_is_the_exception_to_every_rule',
    'has_trouble_remembering_rules_from_one_day_to_another',
}
...
# IMPORTANT: These are the REAL field names from the actual WordPress export, not sanitized test data
...
WORDPRESS_FIELD_MAPPING = {
    ...
    'please_state_your_legal_relationship_to_the_intending_participant': 'Please state your legal relationship to the intending participant',
    ...
    # FASD Screener questions (44 items) - REAL WordPress field names → question_text
    # These field names are from the ACTUAL WordPress camper export
    ...
    'doesnt_connect_cause_and_effect_behavior_and_consequences': "Doesn't connect cause and effect (behavior and consequences)",
    ...
    'moral_chameleon_excessively_vulnerable_to_peer_pressure': 'Moral Chameleon (excessively vulnerable to peer pressure)',
    ...
    'has_group_learning_and_or_using_concept_of_time': 'Has group learning and/or using concept of time',
    ...
    'extremely_vulnerable_to_sales_pitches_ads': 'Extremely vulnerable to sales pitches (ads)',
    ...
    'lies_and_or_replaces_fact_with_fantasy_unconsciously_in_memory': 'Lies and/or replaces fact with fantasy unconsciously in memory',
    'steals_from_family_members': 'Steals from family members',
    'appears_more_capable_than_he_she_really_is': 'Appears more capable than they really are',
    'emotionally_volatile_has_outbursts': 'Emotionally volatile\u037e has outbursts',  # U+037E Greek Question Mark
    'destructive_with_possessions_object': 'Destructive with possessions/object',
    ...
    'looks_innocent_when_confirmed_guilt': 'Looks innocent when confirmed guilty',
    'continues_to_deny_guilt_when_confronted_with_indisputable_evidence': 'Continues to deny guilt when confronted with indisputable evidence',
    'egocentricacts_on_own_needs_first': 'Egocentric — acts on own needs first',
    'unable_to_stay_focused_on_task': 'Unable to stay focused on task',
    'detached_attitude_toward_own_behavior_and_its_consequence': 'Detached attitude toward own behavior and its consequence',
    'takes_the_path_of_least_resistance': 'Takes the path of least resistance',
    'lives_in_the_momentshortsighted': 'Lives in the moment-shortsighted',
    'chooses_immediate_gratification_cant_wait_for_greater_benefit': "Chooses immediate gratification (Can't wait for greater benefit)",
    'doesnt_display_remorse_not_sorry_for_doing_something_wrong': "Doesn't display remorse (Not sorry for doing something wrong)",
    'not_recognized_by_others_as_disabled': 'Not recognized by others as disabled',
    'appears_undisciplined_regardless_of_consistent_discipline_consequences': 'Appears undisciplined regardless of consistent discipline/consequences',
    ...
    'predatoryplans_to_harm_others': 'Predatory-plans to harm others',
    'becomes_angry_when_confronted_with_wrongdoing': 'Becomes angry when confronted with wrongdoing',
    'thinks_he_she_is_the_exception_to_every_rule': 'Thinks they are the exception to every rule',
    'has_trouble_remembering_rules_from_one_day_to_another': 'Has trouble remembering rules from one day to another',
}
